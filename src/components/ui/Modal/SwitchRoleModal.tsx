...
interface SwitchRoleModalProps<T> {
  isSwitchRoleModalVisible: boolean;
  handleCancel: () => void;
...
const SwitchRoleModal: React.FC<SwitchRoleModalProps<any>> = ({
  isSwitchRoleModalVisible,
  handleCancel,
  currentRecord,
  handleUnblock,
  description = " Are You Sure You want to Switch Your Role ?",
}) => {
